const addStructure = () => {
    ...
    const checkboxs = `
        <div class="checkbox-bar">
            <input type=checkbox id="add-intermediate-ap" name="intermediateAp"/><label for="add-intermediate-ap">Intermediate AP Function</label>
...
const addCheckListner = () => {
    $("#add-intermediate-ap").on('click',() => {
        intermediateAp = $("#add-intermediate-ap").prop("checked");
        updateISL();
    });

    $("#add-intermediate-value").on('click',() => {
        intermediateValue = $("#add-intermediate-value").prop("checked");
        updateISL();
    });
    ...
    $("#get-mantissa-exponent").on('click',() => {
        getMantissaExponent = $("#get-mantissa-exponent").prop("checked");
        updateISL();
    });
}
